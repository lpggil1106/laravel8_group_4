    ...
    <div class="d-flex progress-block pb-4 mb-4">
        ...
        <div class="d-flex flex-column align-items-center w-25 position-relative">
            <div class="progress position-absolute">
                <div class="progress-bar bg-success" role="progressbar" style="width: @if($step > 1)100% @elseif($step == 1)30%@else 0% @endif"
        ...
        <div class="d-flex flex-column align-items-center w-25  position-relative">
            <div class="progress position-absolute">
                <div class="progress-bar bg-success" role="progressbar" style="width: @if($step > 2)100% @elseif($step == 2)30%@else 0% @endif"
        ...
        <div class="d-flex flex-column align-items-center w-25  position-relative">
            <div class="progress position-absolute">
                <div class="progress-bar bg-success" role="progressbar" style="width: @if($step > 3)100% @elseif($step == 3)30%@else 0% @endif"
                    aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
