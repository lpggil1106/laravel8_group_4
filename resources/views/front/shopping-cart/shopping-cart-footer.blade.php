<div class="cart-footer">
    ...
    <div class="btns d-flex @if ($step == 4)justify-content-end @else justify-content-between @endif">
        @if ($step == 1)
            <a href="" class="btn btn-lg px-5 backStep_btn">返回購物</a>
            <a href="{{route('shopping-cart.step02')}}" class="btn btn-lg px-5 nextStep_btn">下一步</a>
        @else
            @if ($step == 4)
                <a href="{{route('front.index')}}" class="btn btn-lg px-5 ms-auto nextStep_btn">返回首頁</a>
            @else
